...
# Plotting Sepal Length (index 0) vs Petal Length (index 2)
# Added cmap='viridis' to make the clusters visually distinct!
scatter = ax2.scatter(X[:, 0], X[:, 2], c=clusters, cmap='viridis')
